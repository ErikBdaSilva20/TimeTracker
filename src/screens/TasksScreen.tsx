...
export function TasksScreen() {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    await runMutation(() => tasksRepo.create(payload), {
      successMessage: "Task criada",
      onSuccess: () => {
        setShowForm(false);
    ...
    <>
      ...
      <PageBody>
        ...
        {tasksQ.isLoading ? (
          ...
          <EmptyState
            title="Sem tasks"
            description="Adicione tasks para dividir e acompanhar o trabalho."
          />
        ) : (
          <ResponsiveTable>
                ...
                {tasks.map((t) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3 text-[var(--text-secondary)]">
                      {t.project_id ? projectsMap.get(t.project_id)?.name : "—"}
                    </td>
                    <td className="px-5 py-3 text-[var(--text-secondary)]">
                      {t.member_id ? membersMap.get(t.member_id)?.name : "—"}
                    </td>
                    ...
                    <td className="px-5 py-3 text-right">
                      <button
                        onClick={async () => {
                          ...
                          await runMutation(() => tasksRepo.remove(t.id), {
